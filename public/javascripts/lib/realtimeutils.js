...
define(function(require) {
    ...
    RealtimeUtils.prototype = {
        ...
        init: function(options) {
            ...
            this.authorizer = new RealtimeAuthorizer(this);
        ...
        createRealtimeFile: function(title, callback) {
            ...
            gapi.client.load('drive', 'v2', function() {
                ...
                gapi.client.drive.files.insert(insertHash).execute(callback);
            });
        },
    ...
    /** @constructor
     *
     * @param {RealtimeUtils} realtimeUtil that owns this
     *     RealtimeAuthorizer instance.
     *
     */
    RealtimeAuthorizer = function(realtimeUtil) {
        this.util = realtimeUtil;
        this.handleAuthResult = this.handleAuthResult.bind(this);
        this.token = null;
    };

    RealtimeAuthorizer.prototype = {
